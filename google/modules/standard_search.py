...
# PUBLIC
def search(query, pages=1, lang='en', area='com', ncr=False, void=True, time_period=False, site=False):
    ...
    Args:
        ...
        lang: Language in which page will be displayed
    ...
    for i in range(pages):
        url = _get_search_url(query, i, lang=lang, area=area, ncr=ncr, time_period=time_period, site=site)
        html = get_html(url)
