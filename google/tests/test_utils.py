...
class UtilsTestCase(unittest.TestCase):
    ...
    def test_get_search_url(self):
        ...
        exp_url = "www.google.co.jp/search?q=apple&start=0&num=10&hl=en"
        self.assertEqual(url.replace("http://", "").replace("https://", ""), exp_url)
    ...
    def test_extend_get_search_url(self):
        ...
        exp_url = "www.google.ch/search?q=apple+site%3Aapple.ch&start=0&num=10&hl=en&gl=us&pws=0&gws_rd=cr"
        self.assertEqual(url.replace("http://", "").replace("https://", ""), exp_url)
